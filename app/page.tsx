...
export default function Page() {
  ...
  const handleAddProgram = () => {
    ...
    toast.loading("Processing JSON data...", { id: "add-program" });
    ...
    try {
      ...
      setTimeout(() => {
        console.log("Program added:", parsedJson);

        toast.success("Program added successfully", {
          id: "add-program",
          description:
            "Your JSON data has been processed and added to the program.",
          duration: 3000,
        });

        // Optional: Clear the editor after successful addition
        // setJsonData("")
      }, 800);
    } catch (error) {
      toast.error("Failed to add program", {
        id: "add-program",
        description:
          "The JSON data contains syntax errors. Please fix them and try again.",
        duration: 4000,
      });
    }
  };
