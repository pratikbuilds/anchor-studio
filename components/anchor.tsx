...
export function AddressDisplay({ pubkey }: { pubkey: PublicKey | string }) {
  const [isCopied, setIsCopied] = useState(false);
  const addressString = typeof pubkey === "string" ? pubkey : pubkey.toBase58();
  ...
  return (
    <div className="flex items-center space-x-2">
      ...
      <button
        onClick={handleCopy}
        className="p-1 text-gray-400 hover:text-gray-200 transition-colors duration-150"
        title="Copy address"
      >
        {isCopied ? (
