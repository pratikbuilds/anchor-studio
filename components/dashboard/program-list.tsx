...
import useProgramStore, { type ProgramDetails } from "@/lib/stores/program-store";
    ...
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="overflow-hidden rounded-lg border bg-card text-card-foreground shadow-sm">
        <div className="flex flex-col space-y-1.5 p-6">
          <h3 className="text-2xl font-semibold leading-none tracking-tight">{programDetails.name}</h3>
        ...
        <div className="p-6 pt-0 grid gap-2">
          <div className="text-sm text-muted-foreground">
            Initialized {new Date(programDetails.initializedAt).toLocaleString()}
          </div>
